...
flats_df = pd.read_csv('H:/My Drive/Data Science/Projects/CapStone Project Final Sem BCA/App/data/flats_recommendation.csv')
house_df = pd.read_csv('H:/My Drive/Data Science/Projects/CapStone Project Final Sem BCA/App/data/independent_house_recommendation.csv')
plot_df = pd.read_csv('H:/My Drive/Data Science/Projects/CapStone Project Final Sem BCA/App/data/plot_recommendation.csv')
