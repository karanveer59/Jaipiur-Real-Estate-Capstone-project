...
flats_df = pd.read_csv('data/flats_recommendation.csv')
house_df = pd.read_csv('data/independent_house_recommendation.csv')
plot_df = pd.read_csv('data/plot_recommendation.csv')
